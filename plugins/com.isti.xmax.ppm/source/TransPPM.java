...
public class TransPPM implements ITransformation {
	...
	public void transform(List<IChannel> input, TimeInterval ti, IFilter filter, Object configuration, JFrame parentFrame) {
		...
		if ((input == null) || (input.size() != 2)) {
			...
			try {
				...
				*/
				List<IChannel> inputRepositioned = new ArrayList<IChannel>();
	 ...
	 */
	private XYDataset createDataset(List<IChannel> input, IFilter filter, TimeInterval ti) throws XMAXException {

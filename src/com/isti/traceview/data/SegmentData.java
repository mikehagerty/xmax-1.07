...
public class SegmentData {
	...
	public double sampleRate = Double.POSITIVE_INFINITY;
	public int previous = Integer.MAX_VALUE;
	public int next = Integer.MAX_VALUE;
	public int[] data = null;
	public int sourceSerialNumber = 0;
	public int channelSerialNumber = 0;
	/**

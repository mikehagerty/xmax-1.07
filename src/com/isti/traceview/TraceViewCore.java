...
/**
 * The main class of library, it should be created first to use lib. This class should be used in
 * non-graphics environment, if calling program will have graphics, use TraceView class instead.
 * 
 * @author Max Kokoulin
 */
public class TraceViewCore {
	...
	public static void dumpMemory() {
		...
		r.gc();
		lg
				.debug("Utilized memory: " + (r.totalMemory() - r.freeMemory()) + "; Free memory: " + r.freeMemory() + "; Total memory: "
						+ r.totalMemory());
	}

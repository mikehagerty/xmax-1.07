...
public interface IColorModeState {
	public static Color[] colors = new Color[]{ Color.RED, Color.BLACK, Color.CYAN, Color.GREEN, Color.GRAY, Color.MAGENTA, Color.ORANGE, Color.PINK,	Color.YELLOW, Color.BLUE };

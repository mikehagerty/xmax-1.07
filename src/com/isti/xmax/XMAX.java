...
public class XMAX extends TraceView {
	private static final String version = "1.07 alpha";
	...
	private static Options getOptions() {
		...
		opt.addOption(new Option("o", "order", true, "panel order: 0 - trace name, 1 - network/station/samplerate, 2 - channel, 3 - channel type,  4 - event"));
		...
		opt.addOption(new Option("F", "Format", true, "default block compression format, possible values are SHORT, INT24, INT32, FLOAT, DOUBLE, STEIM1, STEIM2, CDSN, RSTN, DWW, SRO, ASRO, HGLP"));
